...
if choice == "y":
	time.sleep(3)
	os.system("clear")
	Writertext("\033[1;32;40mWait! Generating your deface by Lê Anh Tuấn")
	time.sleep(2)
	fo = open("defaceByLAT.html","w")
	time.sleep(5)
elif choice == "n":
	exit()
...
print(" ")
print ("""The  page has been generated as: defaceByLAT.html""")
